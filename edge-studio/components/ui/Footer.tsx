    ...
    <footer className="relative border-t border-white/10 bg-[#04050b] text-white">
      ...
      <div className="mx-auto max-w-[1200px] px-6 py-16 sm:px-8">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
          ...
          <div className="flex flex-col gap-8 rounded-[26px] border border-white/12 bg-white/6 p-8 shadow-[0_24px_70px_-34px_rgba(14,18,44,0.65)] backdrop-blur">
            <div>
              <h3 className="text-lg font-semibold">Get 10% off your first custom case</h3>
              <p className="mt-3 text-sm text-white/70">No spam, just launch drops and design tips straight from the studio.</p>
            </div>
            <form className="space-y-4" aria-label="Newsletter signup">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-[18px] border border-white/15 bg-[#070818]/80 px-4 py-3 text-sm text-white placeholder:text-white/40 focus:border-transparent focus:outline-none focus:ring-4 focus:ring-cyan-300/45"
                />
              </div>
            ...
            <div className="rounded-[20px] border border-white/10 bg-white/4 p-5 text-sm text-white/70">
        ...
        <div className="mt-16 flex flex-col gap-10 border-t border-white/10 pt-10 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4 text-white/60">
            <button type="button" className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/8 text-white transition hover:border-white/30 hover:text-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-300/45" aria-label="Instagram">
            ...
            <button type="button" className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/8 text-white transition hover:border-white/30 hover:text-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-300/45" aria-label="TikTok">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                <path d="M17 6.1a4.5 4.5 0 0 0 3 1.1V4.2A7 7 0 0 1 14 2v12.5a2.5 2.5 0 1 1-1.9-2.44" />
              </svg>
            </button>
            <button type="button" className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/8 text-white transition hover:border-white/30 hover:text-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-300/45" aria-label="Pinterest">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
                <path d="M14.5 17.5c1.5-1.1 2.5-3 2.5-5 0-3.2-2.4-5.5-5-5.5S7 9.3 7 12.5c0 2 1 3.9 2.5 5" />
                <path d="M12 22l1-6" />
              </svg>
            </button>
            <button type="button" className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/8 text-white transition hover:border-white/30 hover:text-white focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-cyan-300/45" aria-label="YouTube">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5">
          ...
          <div className="flex flex-col gap-4 text-xs text-white/50 lg:flex-row lg:items-center lg:gap-6">
        ...
        <div className="mt-10 text-xs text-white/40">&copy; {new Date().getFullYear()} Edge! Studio. All rights reserved.</div>
      </div>
    </footer>
  );
}
